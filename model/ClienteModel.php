<?php
    ...
    public function consultaID($id){
        ...
        $sql = "SELECT nome,nascimento,salario,codCidade FROM $this->tabela
        WHERE id = ?";
    ...
    public function inserir($nome, $nascimento, $salario, $cidade){
        ...
        $stmt = $this->conn->prepare($sql);
        $stmt->bind_param('ssss',$nome, $nascimento, $salario, $cidade);
        $stmt->execute();
    ...
    public function editar($nome, $nascimento, $salario, $cidade, $id){
        $sql = "UPDATE $this->tabela SET nome = ?, nascimento = ?, salario = ?, codCidade = ?
        WHERE id = ?";
        $stmt = $this->conn->prepare($sql);
        $stmt->bind_param('ssssi',$nome,$nascimento,$salario,$cidade,$id);
        $stmt->execute();
